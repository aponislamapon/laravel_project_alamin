            ...
            <div class="s_product_img">
              ...
              >
                <ol class="carousel-indicators">
                  ...
                  >
                    <img
                      src="{{URL::to('frontend/img/product/single-product/s-product-s-2.jpg')}}"
                      alt=""
                    />
                  </li>
                  <li
                  ...
                  >
                    <img
                      src="{{URL::to('frontend/img/product/single-product/s-product-s-3.jpg')}}"
                      alt=""
                    />
                  </li>
                  <li
                  ...
                  >
                    <img
                      src="{{URL::to('frontend/img/product/single-product/s-product-s-4.jpg')}}"
                      alt=""
                    />
                  </li>
                </ol>
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img
                      class="d-block w-100"
                      src="{{URL::to('frontend/img/product/single-product/s-product-1.jpg')}}"
                      alt="First slide"
                    />
                  </div>
