                ...
                <div class="col-lg-4 col-md-6">
                  <div class="single-product">
                    <div class="product-img">
                      ...
                      />
                      <div class="p_icon">
                        <a href="#" data-toggle="modal" data-target="#acb{{$product['id']}}"  data-id="{{$product['id']}}"  data-photo="{{$product['product_image']}}">
                          <i class="ti-eye"></i>
                        </a>
                        <a href="#">
                          <i class="ti-heart"></i>
                    ...
                    <div class="product-btm">
                      ...
                      <div class="mt-3">
                        ...
                        <!-- modal -->
    <div class="modal fade" id="acb{{$product['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
